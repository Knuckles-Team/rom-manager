...
ROMM_TOOLS: list[tuple[str, str, str, dict[str, str]]] = [
    ...
    (
        ...
        "assets, session login/logout, OAuth token, OpenID, password reset.",
        {
            ...
            "logout": "logout",
            "token": "create_token",  # nosec B105 - action->method name, not a secret
            "oauth_openid": "oauth_openid",
            "forgot_password": "forgot_password",  # nosec B105 - action name, not a secret
            "reset_password": "reset_password",  # nosec B105 - action name, not a secret
        },
    ),
]

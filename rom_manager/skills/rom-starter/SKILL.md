...
name: rom-starter
description: >-
  Rom Manager API + MCP Server + A2A Server Use when working with Rom Manager via this package's MCP
...
license: MIT
tags: [rom-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Rom Manager Starter Skill

Starter skill for the **Rom Manager** package. Use the `mcp-client` universal skill
